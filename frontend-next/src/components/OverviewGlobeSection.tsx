    ...
    const features = [
        {
            ...
            description: 'Access Vietnamese market data with global-grade performance and uptime.',
        },
        {
            name: 'Smart Signals',
            description: 'Surface key valuation and momentum signals to guide decisions faster.',
        },
        {
            name: 'Monitoring & Alerts',
            description: 'Track watchlists and get notified when meaningful moves happen.',
        },
    ];
