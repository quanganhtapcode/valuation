...
export default function WatchlistCard({ externalPrices = {}, useExternalOnly = false }: WatchlistCardProps) {
    ...
    useEffect(() => {
        ...
        const fetchPrices = () => {
            fetch(`/api/market/prices?symbols=${watchlist.join(',')}`, { signal: ctrl.signal })
