...
const CASHFLOW_SECTIONS = [
    {
        ...
        rows: [
            ...
            { key: 'net_profit', label: 'Net Profit After Tax' },
            { key: 'depreciation_fixed_assets', label: 'Depreciation & Amortization' },
            { key: 'provision_credit_loss_real_estate', label: 'Provisions' },
            ...
            { key: 'net_cash_flow_from_operating_activities_before_working_capital', label: 'Operating CF before WC' },
            ...
            { key: 'interest_expense_paid', label: 'Interest Paid' },
            { key: 'corporate_income_tax_paid', label: 'Corporate Income Tax Paid' },
            { key: 'other_cash_from_operating_activities', label: 'Other Cash Receipts' },
            { key: 'other_cash_paid_for_operating_activities', label: 'Other Cash Payments' },
    ...
    },
    {
        ...
        rows: [
            { key: 'purchase_purchase_fixed_assets', label: 'Purchase of Fixed Assets' },
            ...
            { key: 'dividends_and_profits_received', label: 'Dividends & Interest Received' },
    ...
    },
    {
        ...
        rows: [
            { key: 'increase_share_capital_contribution_equity', label: 'Proceeds from Issue of Shares' },
            { key: 'payment_for_capital_contribution_buyback_shares', label: 'Payments for Share Buyback' },
            { key: 'proceeds_from_borrowings', label: 'Proceeds from Borrowings' },
            { key: 'repayments_of_borrowings', label: 'Repayments of Borrowings' },
            { key: 'lease_principal_payments', label: 'Finance Lease Payments' },
            { key: 'dividends_paid', label: 'Dividends Paid' },
            { key: 'other_cash_from_financing_activities', label: 'Other Financing Cash Flows' },
